function Boid(loc, vel, acc, clr, id) {
  ...
  this.render = function() {
    ...
    push();
   image(game.sheep, this.loc.x, this.loc.y, 20, 20);
...
//    this.repelled = false;
    if(this.loc.dist(game.player.loc) < 100 && this.attractToPlayer){
      this.force2 = p5.Vector.sub(game.player.loc, this.loc);
  ...
  //  }
     ...
     if(this.loc.dist(game.attractor.loc) < 250 && !this.isRepelled){
       this.force = p5.Vector.sub(game.attractor.loc, this.loc);
